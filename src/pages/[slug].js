    ...
    >
      ...
      <div className="lg:w-1/2 w-full  mt-9 lg:mt-2 ml-6 lg:ml-0">
        ...
        {product.availableQty<=0 &&<span className="title-font font-medium text-2xl text-gray-900">Out Of Stock!</span>}
          <button disabled={product.availableQty<=0} onClick={()=>{addToCart(slug,1,product.price,product.title,product.size,product.color,product.img)}} className=" disabled:bg-amber-300 ml-8 text-white bg-amber-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-amber-600 rounded">Add to cart</button>
          <button disabled={product.availableQty<=0} className=" disabled:bg-amber-300 ml-4 text-white bg-amber-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-amber-600 rounded" onClick={()=>{buyNow(slug,1,product.price,product.title,product.size,product.color,product.img)}}>Buy Now</button>
