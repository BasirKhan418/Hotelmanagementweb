...
if(localStorage.getItem("cart")){
  ...
  const addToCart =(itemCode,qty,price,name,size,variant,img1,category)=>{
   ...
   if(itemCode in cart){
    ...
    newCart[itemCode]={qty:1,price,name,size,variant,img1,category}
   }
   setCart(newCart);
   saveCart(newCart);
  }
  ...
  const buyNow=(itemCode,qty,price,name,size,variant,img1,category)=>{
    let newCart={}
    newCart[itemCode]={qty:1,price,name,size,variant,img1,category}
    setCart(newCart);
    saveCart(newCart);
