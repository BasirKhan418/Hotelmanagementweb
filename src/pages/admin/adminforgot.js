...
/>
  ...
  <Image alt="logo" src="/cresentlogo.png" width={180} height={60} className='m-auto'/>
    <h2 className="mt-4 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Forgot your account (Admin)</h2>
  </div>
  ...
  {!router.query.token && <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div>
        <button onClick={sendEmailf} type="submit" className="mt-4 flex w-full justify-center rounded-md bg-amber-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-amber-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pink-600">Continue</button>
      </div>
    <p className="mt-10 text-center text-sm text-gray-500">
      Already a member?
      <Link href="/admin/adminlogin" className="font-semibold leading-6 text-amber-600 hover:text-amber-500"> Login</Link>
    </p>
  </div>}
  {router.query.token && <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <div>
      ...
      <div>
        <button onClick={resetPassword} disabled={cpassword!==password} type="submit" className=" disabled:bg-pink-300 flex w-full justify-center rounded-md bg-amber-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-amber-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600 mt-4">Continue</button>
      </div>
