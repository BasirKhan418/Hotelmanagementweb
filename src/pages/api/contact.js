        ...
        <tr>
            <td align="center">
                <table cellpadding="0" cellspacing="0" border="0" width="600" style="background-color: #ffffff;">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <p style="color: #666;">You are receiving this email because you contacted us. If you have any further questions, please don't hesitate to reply to this email hoteldcrescent@gmail.com.</p>
                        </td>
                    </tr>
                </table>
            </td>
          ...
          const info1 = await transporter.sendMail({
            ...
            to: "khanbasir5555@gmail.com, hoteldcrescent@gmail.com", // list of receivers
            subject: `Query Submitted Confirmation `, // Subject line
            text: "Query Submitted Confirmation", // plain text body
            html: `
            <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#f4f4f4">
        <tr>
            <td align="center">
                <table cellpadding="0" cellspacing="0" border="0" width="600" style="background-color: #ffffff;">
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <h1 style="color: #333;">HotelDCrescent User Query</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 20px;">
