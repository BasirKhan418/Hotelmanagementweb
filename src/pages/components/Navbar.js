...
const Navbar = ({
  ...
  return (
    ...
    <div className="space-y-2">
      <span className="block w-8 h-0.5 bg-amber-500 "></span>
      <span className="block w-8 h-0.5 bg-black dark:bg-white font-bold"></span>
      <span className="block w-8 h-0.5 bg-amber-500 "></span>
    </div>
  </div>
        ...
        <div className="nav right hidden lg:flex">
          <ul className="flex justify-center  space-x-2 2xl:space-x-3 items-center overflow-hidden whitespace-nowrap">
            ...
            <Link href={"/mugs"}>
              {" "}
              <li className="text-lg my-2 font-semibold hover:text-pink-400 transition duration-150 ease-out hover:ease-in">Mugs</li>
            </Link>
