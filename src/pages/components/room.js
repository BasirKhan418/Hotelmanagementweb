   ...
   <Swiper
    ...
    <div className="px-5 pb-5">
        ...
        {/* <span className="text-3xl font-bold text-gray-400 dark:text-white line-through ">$599</span> */}
            <span className="sm:text-3xl text-xl font-bold text-gray-900 dark:text-white">₹599/day</span>
            <div className='absolute right-72 sm:right-28 md:right-28 lg:right-28'>
            <Link href={"/rooms"}> <button className="text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold sm:font-medium rounded-lg text-sm px-5 py-2.5 text-center">Book Now</button></Link></div>
        </div>
    </div>
</div>
                </SwiperSlide>
