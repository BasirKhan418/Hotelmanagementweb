...
let breakfast = await Product.find({category:"food",subcategory:"breakfast"});
let lunch = await Product.find({category:"food",subcategory:"lunch"})
let dinner = await Product.find({category:"food",subcategory:"dinner"})
let snacks = await Product.find({category:"food",subcategory:"snacks"})
let fastfood = await Product.find({category:"food",subcategory:"fastfood"})
let other = await Product.find({category:"food",subcategory:{$nin:["breakfast","lunch","dinner","snacks","fastfood"]}});
  return {
      props: {breakfast:JSON.parse(JSON.stringify(breakfast)),lunch:JSON.parse(JSON.stringify(lunch)),dinner:JSON.parse(JSON.stringify(dinner)),other:JSON.parse(JSON.stringify(other)),snacks:JSON.parse(JSON.stringify(snacks)),fastfood:JSON.parse(JSON.stringify(fastfood))},
  };
}
